...
private:
	 ...
	 * diffuse color of the input material.
	 *
	 ...
	 */
	void Import(const std::string &filename, const std::string &folder,
...
public:
	 ...
	 *        be smoothed.
     */
    Mesh(const std::string &filename, const std::string &folder,
